...
|---|---------|---------|------|--------|------|------|
| 3 | 时限预警通知 | `APMS_PART.STATUS = 'in_detailed_analysis'` 且 `SYSDATE - STATUS_CHANGED_AT ≥ warning-days` | 1天/次 | `ANALYST` | — | 精分析即将超时，汇总发送 |
...
| 5 | 审批超期提醒 | `APMS_PART.STATUS = 'pending_approval'` 且 `SYSDATE - STATUS_CHANGED_AT ≥ approval-overdue-days` | 3天/次 | QMC_Leader | — | 审批超时未处理，汇总发送 |
