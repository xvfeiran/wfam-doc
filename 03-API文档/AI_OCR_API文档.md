Workflow 应用 API
密钥：app-Ie53sAIxrvQx68kyvvb3a9Fo
...
POST
/workflows/run
curl -X POST 'vi .env/v1/workflows/run' \
...
POST
/workflows/:workflow_id/run
curl -X POST 'vi .env/v1/workflows/{workflow_id}/run' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "inputs": {},
...
GET
/workflows/run/:workflow_run_id
curl -X GET 'vi .env/v1/workflows/run/:workflow_run_id' \
...
POST
/workflows/tasks/:task_id/stop
curl -X POST 'vi .env/v1/workflows/tasks/:task_id/stop' \
-H 'Authorization: Bearer {api_key}' \
-H 'Content-Type: application/json' \
...
POST
/files/upload
curl -X POST 'vi .env/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
GET
/workflows/logs
curl -X GET 'vi .env/v1/workflows/logs'\
--header 'Authorization: Bearer {api_key}'
...
GET
/parameters
 curl -X GET 'vi .env/v1/parameters'
